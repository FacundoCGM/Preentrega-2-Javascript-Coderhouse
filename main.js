...
alert("Bienvenidos a nuestro concesionario Toyota!")
...
do {
    opcionesTraccion()
    preferenciaTraccion = Number(prompt("elija la opción de tracción que desee:"))
...
do {
    opcionesPropulsion()
    preferenciaPropulsion = Number(prompt("elija la opción de propulsión que desee:"))
